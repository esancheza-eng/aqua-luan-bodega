...
function iniciarListenersDashboard() {
  ...
  const hoy = (typeof fechaHoy==='function') ? fechaHoy() : hoyTop;
  let desde = document.getElementById('filtroFecha').value || hoy;
  let hasta = document.getElementById('filtroFechaHasta').value || hoy;
  if (!desde) desde = hoy;
  if (!hasta || hasta > hoyTop) hasta = hoyTop;
  if (document.getElementById('filtroFecha')) document.getElementById('filtroFecha').value = desde;
...
function limpiarFiltro() {
  ...
  document.getElementById('filtroFecha').value = hoy;
  document.getElementById('filtroFechaHasta').value = hoy;
  if (document.getElementById('filtroAsesor')) document.getElementById('filtroAsesor').value = '';
  _productoFiltroSeleccionado = '';
  if(typeof _sincronizarFechaRutasConDashboard==='function') _sincronizarFechaRutasConDashboard();
  iniciarListenersDashboard();
}
...
function _iniciarListenerPedidosWeb(){
  /* Pedidos Web no está en uso: no se abre listener para no gastar lecturas. */
